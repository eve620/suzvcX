                ...
                {isMenuShow ?
                    ...
                    <svg onClick={showMenu} viewBox="0 0 1024 1024"
                        ...
                        <path
                            ...
                            fill={"#000"}></path>
                        <path d="M160 228m-56 0a56 56 0 1 0 112 0 56 56 0 1 0-112 0Z"
                              fill={"#000"}></path>
                        <path d="M160 512m-56 0a56 56 0 1 0 112 0 56 56 0 1 0-112 0Z"
                              fill={"#000"}></path>
                        <path d="M160 796m-56 0a56 56 0 1 0 112 0 56 56 0 1 0-112 0Z"
                              fill={"#000"}></path>
                    </svg>}
            </div>
        </div>
