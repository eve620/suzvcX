...
const Navbar: React.FC<NavbarProps> = ({currentUser}) => {
    return (
        <header
            className={"text-lg fixed w-full text-black dark:text-white bg-gray-50 dark:bg-gray-800 duration-200 z-10 shadow-md dark:shadow-blue-900/80 font-bold px-3"}>
