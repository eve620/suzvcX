        ...
        <>
            {type === "red" ?
                <button
                    ...
                    <button
                        className={`${big ? "text-md" : "text-sm"} text-nowrap duration-200 inline-block w-fit bold bg-foreground text-background px-3 py-1 rounded hover:opacity-80 dark:hover:opacity-90`}
                        onClick={(e) => {
                            e.preventDefault()
                            onClick()
                        }}>
